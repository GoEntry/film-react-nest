...
-- Заполнение таблицы фильмов тестовыми данными
-- Каждая запись содержит полную информацию о фильме для отображения в приложении
INSERT INTO films (id, rating, director, tags, title, about, description, image, cover) VALUES
-- Документальный фильм о влиянии ИИ на общество
...
-- Антиутопия о совершенном обществе
...
-- Научно-фантастический фильм о космических путешествиях
...
-- Фэнтезийное приключение о защите магического тома
...
-- Фильм о соединении человеческих умов и вопросах приватности
...
-- Фэнтези о волшебном лесе, где время остановилось
